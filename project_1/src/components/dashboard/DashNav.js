...
import {AiOutlineDoubleLeft,AiOutlineDoubleRight, AiOutlineDashboard, AiOutlineFileText, AiOutlineLineChart, AiOutlineLogout, AiOutlineSetting, AiOutlineMenu} from 'react-icons/ai'
...
return (
    ...
    {/*side menu*/}
    <div className={nav ? 'fixed top-0 left-0  h-screen duration-300 z-10 w-[220px] bg-gray-300  ' : 'fixed top-0 left-[-100%] h-screen duration-300  z-10 w-[220px]  bg-gray-300'} >
        ...
        <ul className='flex flex-col text-gray-800 p-4'>
            ...
            <Link to='/dashmain'>
            <div className='flex hover:bg-gray-400 hover:scale-110 duration-200'>
            ...
            <Link to='/login'>
            <div className='flex hover:bg-gray-400 hover:scale-110 duration-200' onClick={handleLogout}>
